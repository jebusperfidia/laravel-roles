<div>
    ...
    <div>
            <a href={{route('user.index')}} class="cursor-pointer btn-intermediary pb-6" variant="primary">
                {{-- Regresar --}}
                Regresar
            </a>
           <div class="w-150">
            <form wire:submit='save' class="mt-6 space-y-6">
               ...
               <flux:input wire:model='confirm_password' label="Confirmar password"  type="password" placeholder="Confirmar Password" />
                <flux:button class="mt-10 btn-primary" type="submit" variant="primary">Guardar cambios</flux:button>
            </form>
           </div>
    </div>
