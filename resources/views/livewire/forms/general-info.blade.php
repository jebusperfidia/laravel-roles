                ...
                <div class="form-container__content">
                    ...
                    <div class="form-grid form-grid--2">
                        ...
                        <flux:field class="flux-field">
                            ...
                            <flux:select wire:model="gi_calculationType"
                ...
                <div class="form-container__content">
                    ...
                    <div class="form-grid form-grid--3 pt-4">
                        ...
                        <flux:field class="flux-field">
                            ...
                            <flux:select wire:model.live="gi_ownerEntity"
                                class="text-gray-800 [&_option]:text-gray-900">
                                <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
                        ...
                        <flux:field class="flux-field">
                            ...
                            <flux:select wire:model.live="gi_ownerLocality"
                                class="text-gray-800 [&_option]:text-gray-900" :disabled="empty($municipalities)">
                                <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
                                @foreach($municipalities as $nombre)
                                <option value="{{ $nombre }}" {{ $nombre===$gi_ownerLocality ? 'selected' : '' }}>
                                    {{ $nombre }}
                                </option>
                                @endforeach
                            </flux:select>
            ...
            <div class="form-container">
                ...
                <div class="form-container__content">
                    ...
                    <div class="form-grid form-grid--3">
                        ...
                        <flux:field class="flux-field">
                            <flux:label>Entidad<span class="sup-required">*</span></flux:label>
                            <flux:select wire:model.live="gi_applicEntity"
                                class="text-gray-800 [&_option]:text-gray-900">
                                <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
                        ...
                        <flux:field class="flux-field">
                            <flux:label>Alcaldia/municipio<span class="sup-required">*</span></flux:label>
                            <flux:select wire:model.live="gi_applicLocality"
                                class="text-gray-800 [&_option]:text-gray-900" :disabled="empty($municipalities2)">
                                <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
                                @foreach($municipalities2 as $nombre)
                                <option value="{{ $nombre }}" {{ $nombre===$gi_applicLocality ? 'selected' : '' }}>
                                    {{ $nombre }}
                                </option>
                                @endforeach
                            </flux:select>
                    ...
                    <div class="form-grid form-grid--3">
                        ...
                        <flux:field class="flux-field">
                            <flux:label>Colonia<span class="sup-required">*</span></flux:label>
                            <flux:select wire:model.live="gi_applicColony"
                                class="text-gray-800 [&_option]:text-gray-900" :disabled="empty($colonies2)">
                                <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
                    ...
                    <div class="form-grid form-grid--3">
                        <flux:field class="flux-field">
                            ...
                            <flux:input.group>
                                ...
                                <flux:button wire:click='buscarCP3' icon="magnifying-glass" class="cursor-pointer">
                                </flux:button>
                            </flux:input.group>
                            <div class="error-container">
                        ...
                        <flux:field class="flux-field">
                            ...
                            <flux:select wire:model.live="gi_propertyLocality"
                                ...
                                <flux:select.option value="a">-- Selecciona una opción --</flux:select.option>
                                @foreach($municipalities3 as $nombre)
                                <option value="{{ $nombre }}" {{ $nombre===$gi_propertyLocality ? 'selected' : '' }}>
                                    {{ $nombre }}
                                </option>
                                @endforeach
                            </flux:select>
                    ...
                    <div class="form-grid form-grid--3">
                        ...
                        <flux:field class="flux-field">
                            ...
                            <flux:select wire:model.live="gi_propertyColony"
                                class="text-gray-800 [&_option]:text-gray-900" :disabled="empty($colonies3)">
                                <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
