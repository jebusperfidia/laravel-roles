                ...
                <div class="form-container__content">
                    <div class="mt-[64px] form-grid form-grid--2-center">
                        <div class="overflow-x-auto">
                            {{-- 1. Cambiamos a min-w-[900px] y table-auto --}}
                            <table class="min-w-[900px] table-auto w-full border-2">
                                <thead>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="px-2 py-2 text-sm text-center">$ {{ number_format($landAvgUnitValue,
                                            2) }}
                                        </td>
                                        <td class="px-2 py-2 text-sm text-center">$ {{
                                            number_format($landHomologatedValue, 2)
                                            }}</td>
                                        <td class="px-2 py-2 text-sm text-center">$ {{ number_format($landProbableValue,
                                            2) }}
                                        </td>
                                        <td class="px-2 py-2 text-sm text-center">
                                        ...
                                        <td class="px-2 py-2 text-sm text-center">
                                            <flux:button
                                                class="btn-primary btn-table cursor-pointer w-30 justify-center"
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-2 py-2 text-sm text-center">$ {{
                                            number_format($buildingAvgUnitValue, 2)
                                            }}</td>
                                        <td class="px-2 py-2 text-sm text-center">$ {{
                                            number_format($buildingHomologatedValue,
                                            2) }}</td>
                                        <td class="px-2 py-2 text-sm text-center">$ {{
                                            number_format($buildingProbableValue, 2)
                                            }}</td>
                                        <td class="px-2 py-2 text-sm text-center">
                                            <flux:button type="button"
                                                class="btn-primary btn-table cursor-pointer w-36 justify-center"
                    ...
                    <div class="mt-4 flex flex-col gap-2">
                        ...
                        <div
                            class="flex items-center gap-2 text-red-600 bg-amber-50 border border-amber-200 p-2 rounded-lg text-xs">
                            <flux:icon.exclamation-triangle variant="mini" />
                            <span>
                                Hay <b>{{ $landExpiredCount }}</b> comparables de <b>terreno</b> que han superado los
                        ...
                        <div
                            ...
                            <flux:icon.exclamation-triangle variant="mini" />
                            <span>
                                Hay <b>{{ $buildingExpiredCount }}</b> comparables de <b>construcción</b> que han
                                superado los 180 días de
                                vigencia.
                            </span>
                        </div>
                        @endif
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-4 text-sm text-center">{{
                                        number_format($applicableUndividedPercent,
                                        0) }} %</td>
                                </tr>
                                <tr>
                                    <td class="px-2 py-4 text-sm text-center">Valor del terreno Prop</td>
                                    <td class="px-2 py-4 text-sm text-center">$ {{ number_format($terrainValue, 2) }}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-4 text-sm text-center">$ {{ number_format($valLoteTipo, 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-2 py-4 text-sm text-center">Diferencia Excedente de Terreno</td>
                                    <td class="px-2 py-4 text-sm text-center">$ {{
                                        number_format($valDiferenciaExcedente,
                                        2)
                                        }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-4 text-sm text-center">$ {{ number_format($valTerrenoExcedente,
                                        2)
                                        }}
                                    </td>
                                </tr>
                        ...
                        <table class="min-w-[550px] table-fixed w-full border-2 ">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="px-2 py-4 text-sm text-center">{{ number_format($saleableBuiltArea, 2) }}
                                        m²
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-4 text-sm text-center">$ {{ number_format($marketValue, 2) }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
