        ...
        <fieldset @disabled($isReadOnly)>
            <div class="form-container">
                ...
                <div class="form-container__content">
                    ...
                    {{-- 1. Superficie vendible --}}
                    <div class="mt-[64px] form-grid form-grid--3 form-grid-3-variation">
                        <div class="label-variation">
                            <flux:label>Superficie vendible:</flux:label>
                        </div>
                    ...
                    {{-- 2. Cálculo de superficie construida --}}
                    <div class="mt-2 form-grid form-grid--3 form-grid-3-variation">
                        <div class="label-variation">
                            <flux:label class="text-center sm:text-left">Cálculo de superficie<br>construida:
                            </flux:label>
                        </div>
                        <div class="radio-input w-full">
                            <flux:field class="w-full flex flex-col items-center sm:items-start">
                                {{-- Contenedor del Checkbox --}}
                                <div class="radio-group-horizontal w-full flex justify-center md:justify-start">
                                    <flux:checkbox wire:model.live='calculationBuiltArea' />
                                </div>

                                {{-- Texto descriptivo --}}
                                <small class="text-[12px] text-gray-500 block text-center md:text-left mt-1">
                                    Si la casilla está seleccionada, el valor en la celda de abajo será siempre igual a
                                    la superficie vendible. Si no,
                                    el valor se introducirá de forma manual y el sistema respetará el valor capturado.
                                </small>
                    ...
                    <div class="mt-2 form-grid form-grid--3 form-grid-3-variation">
                        <div class="label-variation">
                            <flux:label>Superficie construida:</flux:label>
                        </div>
                        <div class="radio-input w-full">
                            <flux:field class="w-full">
                                <div class="radio-group-horizontal w-full">
                                    <flux:input.group>
                                        ...
                                        <flux:input type="number" wire:model='builtArea' step="any" readonly
                                            class="w-full" />
                                        @else
                                        <flux:input type="number" wire:model='builtArea' step="any" class="w-full" />
                                        @endif
                    ...
                    {{-- ESTOS VALORES SON LOS QUE SE DEBEN MOSTRAR EN EL SELECT DE HOMOLOGATION LANDS DE SUPERFICIE
                    APLICABLE --}}
                    <div class="mt-[64px] form-grid form-grid--2-center">
                        <div class="overflow-x-auto">
                            <table class="border-2 w-full min-w-[1000px]">
                                <thead>
                                    <tr class="bg-gray-100">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border px-2 py-1 text-xs text-center">
                                            <flux:field>
                                                <div class="radio-group-horizontal">
                                                    <flux:input.group>
                                                        <flux:input type="number" wire:model='privateLotType'
                                                            step="any" />
                                                        <flux:button disabled><b>m²</b></flux:button>
                                                    </flux:input.group>
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border px-2 py-1 text-xs text-center">
                                            <flux:field>
                                                <div class="radio-group-horizontal">
                                                    <flux:input.group>
                                                        <flux:input type="number" wire:model='surplusLandArea'
                                                            step="any" />
                                                        <flux:button disabled><b>m²</b></flux:button>
                                                    </flux:input.group>
                                                </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="border px-2 py-1 text-sm text-center">
                                            {{ preg_replace('/(\.\d{2,}?)0+$/', '$1',
                                            number_format($totalSurfacePrivate, 6,
                                            '.', ',')) }}
                                        </td>
                                        <td class="border px-2 py-1 text-sm text-center">
                                            {{ preg_replace('/(\.\d{2,}?)0+$/', '$1', number_format($totalSurfaceCommon,
                                            6,
                                            '.', ',')) }}
                                        </td>
                                    </tr>
