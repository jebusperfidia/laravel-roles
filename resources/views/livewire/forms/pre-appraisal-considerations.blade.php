                    ...
                    <div>
                        ...
                        <div x-data="{ open: false }" class="border border-gray-200 rounded-lg mb-4">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                class="overflow-hidden px-4 py-3 text-gray-700">
                                <div class="flex w-full">
                                    <div>
                                        ...
                                        la demanda de dichos bienes, operaciones de compraventa recientes, operaciones
                                        de
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                <div class="flex w-full">
                                    <div>
                                        ...
                                        valuado. A este valor se le aplican los factores de eficiencia de la
                                        construcción
                                        ...
                                        criterios utilizados para la aplicación de los factores de eficiencia de terreno
                                        y
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                <div class="flex w-full">
                                    <div>
                                        ...
                                        <ul>
                                            <li>
                                                <strong>1. </strong>Homologación de terrenos: F. Zona (FZO): influye en
                                                el
                                                ...
                                                según su topografía; F. Forma (FFO): influye en el valor según la forma
                                                del
                                                predio; F. Superficie (FSU): influye
                                                en el valor según la superficie del predio; F. Uso de suelo (FCUS):
                                                influye
                                                en el valor según su edificabilidad
                                                (VST).
                                            </li>
                                            <li>
                                                <strong>2. </strong>Homologación de ventas: Sup. Vendible (FSU): influye
                                                en
                                                el valor según la superficie
                                                construida; F. Intensidad de Const. (FIC): en función de su intensidad
                                                de
                                                construcción; Equipamiento (FEQ): en
                                                función de la existencia de equipamiento; Edad y Conservación (FEDAD):
                                                no
                                                definido; F. Localización (FLOC):
                                                influye en el valor según la localización urbana; Avance obra (AVANC):
                                                no
                                                definido.
                                            </li>
                                            <li>
                                                <strong>3. </strong>Homologación de rentas: Sup. Vendible (FSU): influye
                                                en
                                                el valor según la superficie
                                                construida; F. Intensidad de Const. (FIC): en función de su intensidad
                                                de
                    ...
                    <div>
                        ...
                        <div x-data="{ open: false }" class="border border-gray-200 rounded-lg mb-4">
                            <div @click="open = !open"
                                class="flex justify-between items-center px-4 py-3 cursor-pointer border-b">
                                <div class="flex items-center gap-2 flex-grow">
                                    <span class="text-gray-800 font-medium">Memoria técnica desglose de
                                        información</span>
                                </div>
                                <svg :class="{ 'rotate-180': open }"
                                    class="w-5 h-5 text-gray-500 transform transition-transform duration-300"
