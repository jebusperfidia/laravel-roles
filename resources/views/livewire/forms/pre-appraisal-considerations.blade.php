                    ...
                    <div x-data="{ open: false }" class="border border-gray-200 rounded-lg mb-4">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="flex w-full">
                                <div>
                                    Este enfoque se basa en el uso de información que refleje las transacciones del
                                    mercado, se utiliza en los avalúos de
                                    bienes que pueden ser analizados con bienes comparables existentes en el mercado
                                    abierto, se basa en la investigación de
                                    la demanda de dichos bienes, operaciones de compraventa recientes, operaciones de
                                    renta o alquiler y que, mediante una
                                    homologación de los datos obtenidos, permiten al valuador estimar un valor de
                                    mercado. El supuesto que justifica el
                                    empleo de este método se basa en que un inversionista no pagará más por una
                                    propiedad que lo que estaría dispuesto a
                ...
                <div>
                    ...
                    <div x-data="{ open: false }" class="border border-gray-200 rounded-lg mb-4">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="flex w-full">
                                <div>
                                    El valor unitario de reposición nuevo aplicado a cada tipo de construcción se
                                    determina tomando como referencia los
                                    valores unitarios publicados por empresas especializadas en costos por metro
                                    cuadrado de construcción, tales como los
                                    catálogos de costos BIMSA y PRISMA, realizando los ajustes necesarios para su
                                    adecuación al tipo de construcción
                                    valuado. A este valor se le aplican los factores de eficiencia de la construcción
                                    por concepto de vida útil consumida y
                                    estado de conservación para la conclusión para el valor neto de reposición. La
                                    investigación de mercado, así como los
                                    criterios utilizados para la aplicación de los factores de eficiencia de terreno y
                                    de construcción, se detallan en los
                ...
                <div>
                    ...
                    <div x-data="{ open: false }" class="border border-gray-200 rounded-lg mb-4">
                        <div @click="open = !open"
                            class="flex justify-between items-center px-4 py-3 cursor-pointer border-b">
                            <div class="flex items-center gap-2 flex-grow">
                                <span class="text-gray-800 font-medium">Consideraciones adicionales</span>
                            </div>
                            <svg :class="{ 'rotate-180': open }"
                                class="w-5 h-5 text-gray-500 transform transition-transform duration-300" fill="none"
                                stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div x-data="{ open: false }" class="border border-gray-200 rounded-lg mb-4">
                        <div @click="open = !open"
                            class="flex justify-between items-center px-4 py-3 cursor-pointer border-b">
                            <div class="flex items-center gap-2 flex-grow">
                                <span class="text-gray-800 font-medium">Memoria técnica exposición de motivos</span>
                            </div>
                            <svg :class="{ 'rotate-180': open }"
                                class="w-5 h-5 text-gray-500 transform transition-transform duration-300" fill="none"
                                stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="flex w-full">
                                <div>
                                    ...
                                    <ul>
                                        <li>
                                            <strong>1. </strong>Homologación de terrenos: F. Zona (FZO): influye en el
                                            valor del predio según su ubicación;
                                            F.
                                            Ubicación (FUB): en función de la posición del predio en la manzana; F.
                                            Topografía (FTOP): influye en el valor
                                            según su topografía; F. Forma (FFO): influye en el valor según la forma del
                                            predio; F. Superficie (FSU): influye
                                            en el valor según la superficie del predio; F. Uso de suelo (FCUS): influye
                                            en el valor según su edificabilidad
                                            (VST).
                                        </li>
                                        <li>
                                            <strong>2. </strong>Homologación de ventas: Sup. Vendible (FSU): influye en
                                            el valor según la superficie
                                            construida; F. Intensidad de Const. (FIC): en función de su intensidad de
                                            construcción; Equipamiento (FEQ): en
                                            función de la existencia de equipamiento; Edad y Conservación (FEDAD): no
                                            definido; F. Localización (FLOC):
                                            influye en el valor según la localización urbana; Avance obra (AVANC): no
                                            definido.
                                        </li>
                                        <li>
                                            <strong>3. </strong>Homologación de rentas: Sup. Vendible (FSU): influye en
                                            el valor según la superficie
                                            construida; F. Intensidad de Const. (FIC): en función de su intensidad de
                                            construcción; Equipamiento (FEQ): en
                                            función de la existencia de equipamiento; Edad y Conservación (FEDAD): no
                ...
                <div>
                    ...
                    <div x-data="{ open: false }" class="border border-gray-200 rounded-lg mb-4">
                        <div @click="open = !open"
                            class="flex justify-between items-center px-4 py-3 cursor-pointer border-b">
                            <div class="flex items-center gap-2 flex-grow">
                                <span class="text-gray-800 font-medium">Memoria técnica desglose de información</span>
                            </div>
                            <svg :class="{ 'rotate-180': open }"
                                class="w-5 h-5 text-gray-500 transform transition-transform duration-300" fill="none"
                                stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div x-data="{ open: false }" class="border border-gray-200 rounded-lg mb-4">
                        <div @click="open = !open"
                            class="flex justify-between items-center px-4 py-3 cursor-pointer border-b">
                            <div class="flex items-center gap-2 flex-grow">
                                <span class="text-gray-800 font-medium">Memoria técnica otros para sustento</span>
                            </div>
                            <svg :class="{ 'rotate-180': open }"
                                class="w-5 h-5 text-gray-500 transform transition-transform duration-300" fill="none"
                                stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div x-data="{ open: false }" class="border border-gray-200 rounded-lg mb-4">
                        <div @click="open = !open"
                            class="flex justify-between items-center px-4 py-3 cursor-pointer border-b">
                            <div class="flex items-center gap-2 flex-grow">
                                <span class="text-gray-800 font-medium">Memoria técnica descripción de cálculos
                                    realizados</span>
                            </div>
                            <svg :class="{ 'rotate-180': open }"
                                class="w-5 h-5 text-gray-500 transform transition-transform duration-300" fill="none"
