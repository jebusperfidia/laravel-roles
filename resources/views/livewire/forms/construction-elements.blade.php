<div>
    ...
    <form wire:submit="save">
                ...
                <div class="form-container__content">
                    <div class="flex flex-col w-full h-full">
                        ...
                        <div x-data="{ open: false }" class="w-full">
                            ...
                            'fn1_halfBathroomsNumber', 'fn1_halfBathroomsFlats', 'fn1_halfBathroomsWalls',
                            ...
                            <flux:navbar class="hidden xl:flex bg-white border-b-2">
                                ...
                                <flux:navbar.item wire:click.prevent="setTab('{{ $key }}')"
                                    ...
                                    <span class="text-[16px] flex items-center">
                                        ...
                                        @if ($hasErrors)
                                        <svg class="w-4 h-4 ml-2 text-red-500 fill-current animate-pulse"
                        ...
                        <div x-show="open" x-transition class="xl:hidden bg-white border-b border-gray-200">
                            <ul class="flex flex-col divide-y divide-gray-100">
                                ...
                                @endphp
                                <li>
                                    <button type="button" wire:click.prevent="setTab('{{ $key }}')"
                                        @click="open = false" class="cursor-pointer w-full text-left px-4 py-3 transition-colors
                                            {{ $activeTab === $key
                                        ...
                                        @if ($hasErrors)
                                        <svg class="w-5 h-5 text-red-500 fill-current animate-pulse" viewBox="0 0 20 20"
                    ...
                    {{-- <div class="form-container__content"> --}}
                            ...
                            <div class="overflow-x-auto max-w-full">
                                <table class="min-w-[550px] table-fixed w-full border-2 ">
                                    ...
                                    <tbody>
                                        {{-- hall --}}
                                        <tr>
                                            <td class="px-2 py-1 border text-sm text-center">Sala<span
                                                    class="sup-required">*</span></td>
                                        ...
                                        {{-- stay-diningRoom --}}
                                        <tr>
                                            <td class="px-2 py-1 border text-sm text-center">Estancia / comedor<span
                                                    class="sup-required">*</span></td>
                                            <td class="px-2 py-1 border text-sm"></td>
                                            <td class="px-2 py-1 border text-sm">
                                                <flux:field class="flux_field pt-8">
                                        ...
                                        {{-- Kitchen --}}
                                        <tr>
                                            <td class="px-2 py-1 border text-sm text-center">Cocina<span
                                                    class="sup-required">*</span></td>
                                            <td class="px-2 py-1 border text-sm"></td>
                                            <td class="px-2 py-1 border text-sm">
                                                <flux:field class="flux_field pt-8">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-2 py-1 border text-sm">
                                                <flux:field class="flux_field pt-8">
                                                    <flux:textarea wire:model.live='fn1_bedroomsFlats'
                                                        :disabled="$fn1_bedroomsNumber === 0" />
                                                    <div class="error-container">
                                            ...
                                            <td class="px-2 py-1 border text-sm">
                                                <flux:field class="flux_field pt-8">
                                                    <flux:textarea wire:model='fn1_bathroomsFlats'
                                                        :disabled="$fn1_bathroomsNumber === 0" />
                                                    <div class="error-container">
                                            ...
                                            <td class="px-2 py-1 border text-sm">
                                                <flux:field class="flux_field pt-8">
                                                    <flux:textarea wire:model='fn1_halfBathroomsFlats'
                                                        :disabled="$fn1_halfBathroomsNumber === 0" />
                                                    <div class="error-container">
                                        ...
                                        {{-- covered parking --}}
                                        <tr>
                                            <td class="px-2 py-1 border text-sm text-center">Estacionamiento cubierto
                                            </td>
                                            <td class="px-2 py-1 border">
                                                <flux:field>
                        ...
                        {{-- <flux:modal.trigger name="add-item" class="flex justify-end"> --}}
                            @if(!$isReadOnly)
                            <flux:button type="button" class="btn-primary btn-table cursor-pointer mt-2" icon="plus"
                                wire:click='openAddElement'>
                            </flux:button>
                            @endif
                            {{--
                        </flux:modal.trigger> --}}
                            ...
                            <div class="overflow-x-auto max-w-full">
                                <table class="min-w-[550px] table-fixed w-full border-2 ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="px-2 py-1 border text-xs text-center">{{ $finishingOther->space
                                                }}</td>
                                            <td class="px-2 py-1 border text-xs text-center">{{ $finishingOther->amount
                                                }}</td>
                                            <td class="px-2 py-1 border text-sm text-center">{{ $finishingOther->floors
                                                }}</td>
                                            <td class="px-2 py-1 border text-sm text-center">{{ $finishingOther->walls
                                                }}</td>
                                            <td class="px-2 py-1 border text-sm text-center">{{
                                                $finishingOther->ceilings }}</td>
                                            ...
                                            <td class="px-2 py-1 border flex justify-evenly">
                                                ...
                                                <flux:button type="button" icon-leading="pencil"
                                                    ...
                                                    wire:click="openEditElement({{ $finishingOther->id }})" />

                                                {{-- Botón Eliminar --}}
                                                <flux:button
                                                    onclick="confirm('¿Estás seguro?') || event.stopImmediatePropagation()"
                                                    wire:click="deleteItem({{ $finishingOther->id }})" type="button"
                                                    icon-leading="trash"
                        ...
                        <div class="form-container__content">
                            ...
                            <div class="form-grid form-grid--2">
                                ...
                                <flux:field class="flux_field pt2">
                                    <flux:label>Recubrimientos especiales<span class="sup-required">*</span>
                                    </flux:label>
                        ...
                        <div class="form-container__content">
                            ...
                            <div class="form-grid form-grid--2">
                                ...
                                <flux:field class="flux_field pt2">
                                    <flux:label>Muebles empotrados o fijos en recámaras<span
                                            class="sup-required">*</span>
                                    </flux:label>
                        ...
                        <div class="form-container__content">
                            <div class="form-grid form-grid--2">
                                <flux:field class="flux_field pt2">
                                    <flux:label>Puerta de patio de servicio<span class="sup-required">*</span>
                                    </flux:label>
            ...
            <div class="form-container__content">
                ...
                <flux:modal name="add-element" class="md:w-96">
                    <div class="space-y-6">
                        ...
                        <div class="flex">
                            <flux:spacer />
                            @if(!$isReadOnly)
                            <flux:button type="button" wire:click='addItem'
                ...
                <flux:modal name="edit-element" class="md:w-96">
                    <div class="space-y-6">
                        ...
                        <div class="flex">
                            ...
                            <flux:button type="button" wire:click='editItem'
                                class="btn-primary btn-table cursor-pointer">Editar
                ...
                {{-- Al final del form, ocultamos el botón de guardado --}}
                @if(!$isReadOnly)
