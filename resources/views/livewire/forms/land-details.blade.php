<div>
    <div x-data="mapViewer()" x-init="init()">
        ...
        @endif
        @if(!$isReadOnly)
        <div class="flex justify-end font-semibold text-sm text-red-600 pt-2 -mb-3"><span>* Campos obligatorios</span>
        </div>
        @endif
        ...
        <form wire:submit="save">
            <fieldset @disabled($isReadOnly)>
                        ...
                        <div class="form-grid form-grid--3">
                            <flux:field class="flux-field">
                                ...
                                <flux:select wire:model.live="sli_sourceLegalInformation"
                                    ...
                                    <flux:select.option value="Alineamiento y numero oficial">Alineamiento y numero
                                        oficial
                                    </flux:select.option>
                                    <flux:select.option value="Titulo de propiedad">Titulo de propiedad
                                    </flux:select.option>
                                    <flux:select.option value="Otra fuente de informacion legal">Otra fuente de
                                        información
                ...
                <div class="form-container">
                    ...
                    <div class="form-container__content">
                        ...
                        <div class="font-semibold text-sm text-red-600 mb-2"><span>Debes guardar los datos principales
                                para
                        ...
                        <div class="form-grid form-grid--3 form-grid-3-variation">
                            ...
                            <div>
                                ...
                                @if(!$isReadOnly)
                                <div class="mt-4">
                                    <flux:button wire:click="uploadFiles" class="btn-primary btn-files cursor-pointer">
                                        Cargar
                                        archivos
                                    </flux:button>
                                </div>
                        ...
                        <div class="form-grid form-grid--3 form-grid-3-variation mb-4">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <div class="relative border p-2 rounded shadow bg-white">
                                    ...
                                    <img src="{{ asset('land_details/' . $file->file_path) }}"
                                        alt="{{ $file->original_name }}" class="w-full h-32 object-cover rounded">
                                    ...
                                    <div class="flex flex-col items-center justify-center h-32">
                                        ...
                                        <svg class="w-10 h-10 text-red-500 mb-2" fill="currentColor"
                                            viewBox="0 0 20 20">
                                            <path
                                    ...
                                    @elseif ($file->file_type === 'pdf')
                                    <div class="w-full">
                                        <embed src="{{ asset('land_details/' . $file->file_path) }}"
                        ...
                        {{-- @if (!$landDetail)
                        <div class="font-semibold text-sm text-red-600"><span>Debes guardar los datos principales para
                                poder
                                usar esta
                                opción</span></div>
                        @endif --}}
                        ...
                        <div class="flex justify-between text-lg border-b-2 border-gray-300 mt-8">
                            ...
                            @if(!$isReadOnly)
                            <flux:button class="btn-primary btn-table cursor-pointer mb-2" wire:click='openAddGroup'>
                                Agregar
                                grupo</flux:button>
                            @endif
                        </div>
                                    ...
                                    <div class="overflow-x-auto w-full border border-gray-200 rounded-lg">
                                        <table class="min-w-[550px] table-fixed w-full">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="my-2 flex justify-evenly">
                                                        ...
                                                        <flux:button
                                                            ...
                                                            wire:click="deleteElement({{ $neighbor->id }})"
                                                ...
                                                @empty
                                                <tr>
                                                    <td colspan="4" class="text-center py-2 text-gray-500">No hay
                                                        elementos
                                                        en este
                                                        grupo.</td>
                                                </tr>
                ...
                <div class="form-container">
                    ...
                    <div class="form-container__content">
                        ...
                        <div class="form-grid form-grid--2">
                            ...
                            <flux:field class="flux-field">
                                <flux:label>Orientación calle transversal<span class="sup-required">*</span>
                                </flux:label>
                        ...
                        <div class="form-grid form-grid--2">
                            ...
                            <flux:field class="flux-field">
                                ...
                                <flux:select wire:model="ct_configuration"
                                    class=" text-gray-800 [&_option]:text-gray-900">
                                    <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
                        ...
                        <div class="form-grid form-grid--2">
                            <flux:field class="flux-field">
                                ...
                                <flux:select wire:model="ct_topography" class=" text-gray-800 [&_option]:text-gray-900">
                                    ...
                                    <flux:select.option value="4. Con pendiente descendente">4. Con pendiente
                                        descendente
                                    </flux:select.option>
                                </flux:select>
                                <div class="error-container">
                        ...
                        <div class="form-grid form-grid--2">
                            ...
                            <flux:field class="flux-field">
                                ...
                                <flux:select wire:model.live="ct_EasementRestrictions"
                                    class=" text-gray-800 [&_option]:text-gray-900">
                                    <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
                                    <flux:select.option value="No existen restricciones de construccion en el terreno">
                                        No
                                        existen
                                        restricciones de construccion en el terreno</flux:select.option>
                                    <flux:select.option value="Las propias del reglamento de construccion vigente">Las
                                        propias
                                        del
                                    ...
                                    <flux:select.option
                                        ...
                                        Las propias del programa delegacional de desarrollo urbano, en cuanto a numero
                                        de
                                        niveles,
                        ...
                        <div class="form-grid form-grid--2">
                            <flux:field class="flux-field">
                                <flux:label>Especifique otras (servimbre y/o restricciones)<span
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="px-2 py-1 text-xs text-center">{{
                                                number_format($surface->surface, 2)
                                                }}
                                            </td>
                                            {{-- <td class="px-2 py-1 text-xs text-center">{{
                        ...
                        <div class="form-grid form-grid--3 form-grid-3-variation pt-8">
                            ...
                            <div class="radio-input">
                                <flux:field>
                                    <div class="radio-group-horizontal">
                                        <flux:input.group>
                                            <flux:input type="number" wire:model.lazy='ls_surfacePrivateLot'
                                                step="any" />
                        ...
                        <div class="form-grid form-grid--3 form-grid-3-variation pt-8">
                            ...
                            <div class="radio-input">
                                <flux:field>
                                    <div class="radio-group-horizontal">
                                        <flux:input.group>
                                            <flux:input type="number" wire:model.lazy='ls_surfacePrivateLotType'
                                                step="any" />
                                            <flux:button disabled><b>m²</b></flux:button>
                                        </flux:input.group>
                                    </div>
            ...
            <flux:modal name="add-group" class="md:w-96">
                <fieldset @disabled($isReadOnly)>
                    <div class="space-y-6">
                        ...
                        <div class="flex">
                            <flux:spacer />
                            <flux:button type="button" wire:click='addGroup' class="btn-primary cursor-pointer">Crear
                                grupo
                            </flux:button>
                        </div>
                        @endif
            ...
            <flux:modal name="add-element" class="md:w-96">
                <fieldset @disabled($isReadOnly)>
                    <div class="space-y-6">
                        ...
                        <div class="flex">
                            <flux:spacer />
                            <flux:button type="button" wire:click='addElement' class="btn-primary cursor-pointer">Crear
                                elemento
                            </flux:button>
                        </div>
                        @endif
            ...
            <flux:modal name="edit-element" class="md:w-96">
                <fieldset @disabled($isReadOnly)>
                    <div class="space-y-6">
                        ...
                        <div class="flex">
                            <flux:spacer />
                            <flux:button type="button" wire:click='editElement' class="btn-primary cursor-pointer">
                                Editar
                                elemento
                            </flux:button>
                        </div>
            ...
            <flux:modal name="add-LandSurface" class="md:w-96">
                <fieldset @disabled($isReadOnly)>
                    <div class="space-y-6">
                        ...
                        <div class="flex">
                            <flux:spacer />
                            <flux:button type="button" wire:click='addLandSurface' class="btn-primary cursor-pointer">
                                Crear
                                elemento
                            </flux:button>
                        </div>
            ...
            <flux:modal name="edit-LandSurface" class="md:w-96">
                <fieldset @disabled($isReadOnly)>
                    <div class="space-y-6">
                        ...
                        <div class="flex">
                            <flux:spacer />
                            <flux:button type="button" wire:click="editLandSurface" class="btn-primary cursor-pointer">
                                Editar
                                elemento
                            </flux:button>
                        </div>
            ...
            <div class="form-container__footer">
                <flux:button class="btn-primary cursor-pointer" type="button" wire:click.prevent="save">
                    Guardar datos
                </flux:button>
            </div>
            @endif
            ...
            function mapViewer() {
                return {
                    ...
                    createOrUpdateMaps(lat, lon, alt = 0) {
                        ...
                        setupMap(this.$refs.mapMicro, this.maps.micro, 16);
                    },
