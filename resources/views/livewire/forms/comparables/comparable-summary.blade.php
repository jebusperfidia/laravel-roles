        ...
        <div class="space-y-6">
            ...
            <div class="px-6 py-4 border-b flex justify-between items-center">
                ...
                <flux:button type="button" class="btn-primary btn-sm cursor-pointer" {{-- Confirmación: Pide al usuario que confirme
                    ...
                    {{-- Disparador: Si acepta, disparamos el evento a ComparableIndex --}}
                    wire:click="$dispatch('copyComparable', { id: {{ $comparable->id }} })">
                    Copiar comparable
                </flux:button>
                @endif
                {{-- *** FIN BOTÓN DE COPIA *** --}}
            ...
            <div class="p-6">
                ...
                <div class="form-grid form-grid--2 gap-x-8 gap-y-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-4 mb-6">
                            <div
                                ...
                                <img src="{{ asset('comparables/'.$comparable->comparable_photos) }}"
                                    alt="Foto del comparable" class="w-full h-full object-cover">
                                @else
                    ...
                    <div>
                        ...
                        <h4 class="font-bold text-lg text-gray-700 mt-6 mb-4 border-b pb-1">Avaluos donde está asignado
                        </h4>
