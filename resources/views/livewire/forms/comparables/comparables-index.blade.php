<div>
                    ...
                    <table class="table-fixed min-w-[1810px] w-full border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr wire:key="comparable-{{ $item->id }}"
                                ...
                                <td class="px-2 py-2 border text-sm text-center">{{ $item->comparable_entity }}
                                </td>
                                <td class="px-2 py-2 border text-sm text-center">{{ $item->comparable_locality }}
                                </td>
                                <td class="px-2 py-2 border text-sm text-center">
                                    {{ ($item->comparable_colony == 'no-listada') ? $item->comparable_other_colony :
                                    $item->comparable_colony }}
                                </td>
                                ...
                                <td class="px-2 py-2 border text-center">
                                    <div class="flex justify-center gap-4">
                                        ...
                                        <flux:button class="btn-intermediary btn-table text-sm cursor-pointer"
                                            ...
                                            :disabled="$item->created_by != $userSession->id" {{-- Nueva Lógica de
                                            Creador --}}>
                                            Editar
                                        </flux:button>
    ...
    <div>
        ...
        @if($comparableType === 'land')
        <flux:button class="mt-4 cursor-pointer btn-primary" wire:click="backToHomologationLand" variant="primary">
            Homologar
            terrenos
        </flux:button>
        @else
        {{-- ($comparableType === 'building') --}}
        <flux:button class="mt-4 cursor-pointer btn-primary" wire:click="backToHomologationBuilding" variant="primary">
            Homologar
        </flux:button>
        @endif
    </div>
        ...
        <div class="space-y-4">
            ...
            <flux:field class="flux-field">
                ...
                <flux:select wire:model="comparableProperty" class="text-gray-800 [&_option]:text-gray-900">
                    ...
                    <flux:select.option value="Casa habitacion en condominio">Casa habitacion en condominio
                    </flux:select.option>
                    <flux:select.option value="Departamento en condominio">Departamento en condominio
                    </flux:select.option>
            ...
            <flux:field class="flux-field">
                ...
                <flux:select wire:model.live="comparableLocality" class="text-gray-800 [&_option]:text-gray-900"
                    ...
                    <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
                    @foreach($municipalities as $nombre)
                    <option value="{{ $nombre }}" {{ $nombre===$comparableLocality ? 'selected' : '' }}>
                        {{ $nombre }}
                    </option>
                    @endforeach
                </flux:select>
            ...
            <flux:field class="flux-field">
                ...
                <flux:input.group>
                    <flux:select wire:model.live="comparableServicesInfraestructure"
            ...
            <flux:field class="flux-field">
                ...
                <flux:input.group>
                    ...
                    <flux:select wire:model.live="comparableTopography" class="text-gray-800 [&_option]:text-gray-900">
                        <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
            ...
            <flux:field class="flux-field">
                ...
                <flux:input.group>
                    <flux:select wire:model.live="comparableNumberBedrooms"
                        class="text-gray-800 [&_option]:text-gray-900">
                        <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
            ...
            <flux:field class="flux-field">
                ...
                <flux:input.group>
                    <flux:select wire:model.live="comparableNumberToilets"
                        class="text-gray-800 [&_option]:text-gray-900">
                        <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
                        @for($i = 0; $i <= 10; $i++) <flux:select.option value="{{ $i }}">{{ $i }}</flux:select.option>
                            @endfor
            ...
            <flux:field class="flux-field">
                ...
                <flux:input.group>
                    <flux:select wire:model.live="comparableNumberHalfbaths"
                        class="text-gray-800 [&_option]:text-gray-900">
                        <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
                        @for($i = 0; $i <= 10; $i++) <flux:select.option value="{{ $i }}">{{ $i }}</flux:select.option>
                            @endfor
            ...
            <flux:field class="flux-field">
                ...
                <flux:input.group>
                    <flux:select wire:model.live="comparableNumberParkings"
                        class="text-gray-800 [&_option]:text-gray-900">
                        <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
                        @for($i = 0; $i <= 10; $i++) <flux:select.option value="{{ $i }}">{{ $i }}</flux:select.option>
                            @endfor
            ...
            <flux:field class="flux-field">
                ...
                <flux:input.group>
                    <flux:select wire:model.live="comparableNumberFloorLevel"
                        class="text-gray-800 [&_option]:text-gray-900">
                        <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
            ...
            <flux:field class="flux-field">
                ...
                <flux:input.group>
                    <flux:select wire:model.live="comparableConservation"
                        class="text-gray-800 [&_option]:text-gray-900">
                        <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
            ...
            <flux:field class="flux-field">
                ...
                <flux:input.group>
                    ...
                    <flux:select wire:model.live="comparableClasification"
                        class="text-gray-800 [&_option]:text-gray-900">
                        <flux:select.option value="">-- Selecciona una opción --</flux:select.option>
            ...
            <flux:field class="flux-field">
                ...
                @if ($comparablePhotosFile && is_string($comparablePhotosFile) &&
                Storage::disk('comparables_public')->exists($comparablePhotosFile))
                <div>
                ...
                <div class="min-h-[40px]">
                    <div wire:loading wire:target="comparablePhotosFile"
                        class="text-sm text-blue-600 flex items-center gap-2">
            ...
            <div class="flex">
                ...
                <flux:button class="btn-primary btn-table cursor-pointer" type="button" variant="primary"
                    wire:click='comparableUpdate'>Editar
                    comparable</flux:button>
            </div>
            @endunless
