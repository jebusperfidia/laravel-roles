<div>
 ...
 --}}
    ...
    {{--   <div class="flex w-full flex-wrap justify-between gap-6 max-w-screen-2xl mx-auto px-4">
     <!-- Card Azul -->
     <button wire:click="setView('assigned')"
     class="flex-grow basis-0 min-w-[220px] p-6 rounded-xl shadow-md
     bg-gradient-to-br from-blue-700 via-blue-500 to-blue-300
     text-white transition-transform hover:scale-105 hover:shadow-lg cursor-pointer">
     <div class="text-4xl font-bold">0</div>
     <div class="mt-4 text-base font-semibold">Por Asignar</div>
...
--}}
    ...
    {{-- //El que mejor jala XD --}}
    {{-- <div class="flex flex-wrap w-full gap-6 px-4 max-w-screen-2xl mx-auto">
    <!-- Card Azul -->
  <button wire:click="setView('assigned')"
  class="flex-grow min-w-[calc(50%-1.5rem)] lg:min-w-[calc(25%-1.5rem)] p-6 rounded-xl shadow-md
  bg-gradient-to-br from-blue-700 via-blue-500 to-blue-300
  text-white transition-transform hover:scale-105 hover:shadow-lg cursor-pointer">
  <div class="text-4xl font-bold">0</div>
  <div class="mt-4 text-base font-semibold">Por Asignar</div>
...
--}}
    ...
    {{-- Versión 2 bien --}}
    {{-- <div class="flex gap-6 px-4 max-w-screen-2xl mx-auto">
    <button wire:click="setView('assigned')"
