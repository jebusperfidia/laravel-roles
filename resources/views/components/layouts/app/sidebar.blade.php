    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group :heading="__('Menu')" class="grid">
                ...
                <flux:navlist.item icon="users" :href="route('user.index')" :current="request()->routeIs('user.index')"
                ...
                @endif
                {{-- <flux:navlist.item icon="archive-box" :href="route('valuation.archived')"
                    :current="request()->routeIs('valuation.archived')" wire:navigate>{{ __('Avalúos archivados') }}
                </flux:navlist.item> --}}
        ...
        <flux:dropdown class="hidden lg:block" position="bottom" align="start">
            ...
            <flux:menu class="w-[220px]">
                ...
                <flux:menu.radio.group>
                    <flux:menu.item :href="route('settings.profile')" icon="cog" class="cursor-pointer" wire:navigate>{{
                        'Ajustes' }}
                    </flux:menu.item>
                </flux:menu.radio.group>
