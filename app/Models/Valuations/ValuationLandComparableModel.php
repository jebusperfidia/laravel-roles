...
// Ruta: App\Models\Forms\Comparable\ValuationLandComparableModel.php
...
/**
 * Modelo para la "HojaDeConexion" (tabla pivote) 'valuation_land_comparables'.
 * ¡¡ESTE ES UN MODELO COMPLETO!!
 */
class ValuationLandComparableModel extends Model // <-- ¡NO ES PIVOT!
{
    ...
    public function factors()
    {
        ...
        return $this->hasMany(HomologationComparableFactorModel::class, 'valuation_land_comparable_id');
    }
